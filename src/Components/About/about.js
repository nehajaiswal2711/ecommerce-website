...
function About() {
  return (
    ...
    >
      ...
      >
        <img
          src="https://plus.unsplash.com/premium_photo-1680373109883-47a3617e9acd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fGJhZ3xlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=250&q=60&&h=250"
          style={{ maxWidth: "100%", height: "auto" }} // Ensure image resizes
          alt="Placeholder"
        />
      </div>
